...
{
    public class STREMENModel : PageModel
    {
        private readonly ILogger<STREMENModel> _logger;
        public JsonFileTorroService TorroService;
        public IEnumerable<Torro>Torros { get; private set; }

        public STREMENModel(ILogger<STREMENModel> logger,
        ...
        {
            Torros = TorroService.GetSTREMEN();
