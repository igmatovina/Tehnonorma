...
{
    public class PRSTENModel : PageModel
    {
        private readonly ILogger<PRSTENModel> _logger;
        public JsonFileTorroService TorroService;
        public IEnumerable<Torro>Torros { get; private set; }

        public PRSTENModel(ILogger<PRSTENModel> logger,
