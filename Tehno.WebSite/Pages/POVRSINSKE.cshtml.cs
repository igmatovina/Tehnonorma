...
{
    public class POVRSINSKEModel : PageModel
    {
        private readonly ILogger<POVRSINSKEModel> _logger;
        public JsonFileTorroService TorroService;
        public IEnumerable<Torro>Torros { get; private set; }

        public POVRSINSKEModel(ILogger<POVRSINSKEModel> logger,
        ...
        {
            Torros = TorroService.GetPOVRSINSKE();
