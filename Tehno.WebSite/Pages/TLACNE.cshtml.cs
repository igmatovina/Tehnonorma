...
{
    public class TLACNEModel : PageModel
    {
        private readonly ILogger<TLACNEModel> _logger;
        public JsonFileTorroService TorroService;
        public IEnumerable<Torro>Torros { get; private set; }

        public TLACNEModel(ILogger<TLACNEModel> logger,
